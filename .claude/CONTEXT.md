...
```
animator/
├── src/my_project/    # Main package source code
...
- Version is tracked in `pyproject.toml` and `src/my_project/__init__.py`
...
- **Source code** lives in `src/my_project/`
- **Tests** mirror source structure in `tests/`
- **Configuration** files in `src/my_project/settings/`
- **Entry point** for application in `src/my_project/main.py` (if created)
